...
# Model choices
tf.flags.DEFINE_string('clf', 'clstm', "")
...
tf.flags.DEFINE_integer('embedding_size', 256, 'Word embedding size. C-LSTM.')
tf.flags.DEFINE_string('filter_sizes', '3, 4, 5', 'CNN filter sizes. C-LSTM.')
tf.flags.DEFINE_integer('num_filters', 128, 'Number of filters per filter size. C-LSTM.')
tf.flags.DEFINE_integer('num_layers', 2, 'Number of the LSTM cells. C-LSTM')
